                        ...
                        if (column.isSelector) {
                            ...
                            if (val !== '') {
                                ...
                                while (escMatch) {
                                    ...
                                    newVal = lastIdx !== escMatch.index ? newVal + val.substr(lastIdx, escMatch.index - lastIdx) + escMatch[0].slice(-1) : newVal + escMatch[0].slice(-1);
