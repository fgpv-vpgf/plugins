...
export const TABLE_LOADING_TEMPLATE = (legendEntry) =>
    // hhite match parent
    `<div class="rv-table-splash">
        <div class="rv-splash-count">
            <span class="rv-splash-count-current">${legendEntry.loadedFeatureCount}</span>
        ...
        <span class="rv-splash-message md-caption">{{ ${legendEntry.loadedFeatureCount} < ${legendEntry.featureCount} ? 'table.splash.loadingdata' : 'table.splash.buildingtable' | translate }} </span>
