...
var TableBuilder = /** @class */ (function () {
    ...
    TableBuilder.prototype.init = function (mapApi) {
        ...
        this.mapApi.ui.configLegend._legendStructure._root._tableToggled.subscribe(function (legendBlock) {
            if (_this.panel.panelStateManager !== undefined) {
                // switch state of whether the table is open or not
                _this.panel.panelStateManager.isOpen = !_this.panel.panelStateManager.isOpen;
            }
            if (_this.panel.panelStateManager === undefined ||
                _this.panel.panelStateManager.isOpen === true ||
                legendBlock !== _this.panel.panelStateManager.legendBlock) {
                ...
                if (_this.panel.panelStateManager !== undefined && legendBlock !== _this.panel.panelStateManager.legendBlock) {
    ...
    TableBuilder.prototype.findMatchingLayer = function (legendBlock) {
        ...
        if (legendBlock.blockType === 'node') {
            ...
            if (layer) {
                ...
                this.layerAdded = this.mapApi.layers.layerAdded.subscribe(function (layer) {
        ...
        if (attrs.length === 0) {
            ...
            this.mapApi.layers.attributesAdded.pipe(take_1.take(1)).subscribe(function (attrs) {
                if (attrs.attributes.length > 0) {
                    ...
                    _this.loadingPanel.prepareBody(); // update loader number
            ...
            this.loadingPanel.prepareBody(); // update loader number
            this.createTable({
                attributes: attrs,
                layer: baseLayer
            });
...
function setUpSymbolsAndInteractive(columnName, colDef, cols, panel) {
    if (columnName === 'rvSymbol' || columnName === 'rvInteractive') {
        ...
        if (columnName === 'rvSymbol') {
            ...
            zoomDef.cellRenderer = function (params) {
                var eSpan = new panel.container(templates_1.ZOOM_TEMPLATE(params.data.OBJECTID)).elementAttr[0];
            ...
            colDef.cellRenderer = function (params) {
                var eSpan = new panel.container(templates_1.DETAILS_TEMPLATE(params.data.OBJECTID)).elementAttr[0];
                params.eGridCell.addEventListener('keydown', function (e) {
                    if (e.key === 'Enter') {
                        eSpan.click();
                    }
